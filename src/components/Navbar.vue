<template>
  <div class="flex flex-wrap items-center justify-between p-6 bg-gray-700">
    
    <div class="text-gray-400">
        <router-link to="/">
        <div class="h-8 w-8  hover:text-white hover:border-white">
...
<div @click="menu_status()">
        ...
        <button id='boton' class="flex items-center px-2 py-1 text-gray-400 border border-gray-600 rounded hover:text-white hover:border-white">
    ...
    <div id='menu' class="flex-grow  w-full hidden" >
      <div class="">
        ...
        <router-link to="/login" class="block mt-3 font-sans text-gray-400 text-md hover:text-white">
